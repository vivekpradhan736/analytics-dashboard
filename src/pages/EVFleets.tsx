...
const EVFleets = () => {
  ...
  const batteryHealthTrends = [
    { month: "Jan", tesla: 94, nissan: 88, ford: 97, avgTemp: 45 },
    { month: "Feb", tesla: 93, nissan: 87, ford: 97, avgTemp: 52 },
    { month: "Mar", tesla: 93, nissan: 86, ford: 96, avgTemp: 58 },
    { month: "Apr", tesla: 92, nissan: 86, ford: 96, avgTemp: 65 },
    { month: "May", tesla: 92, nissan: 85, ford: 96, avgTemp: 72 },
    { month: "Jun", tesla: 92, nissan: 85, ford: 96, avgTemp: 78 }
  ];
  ...
  const geographicPerformance = [
    { city: "San Francisco", vehicles: 12, avgHealth: 91, avgRange: 278, climate: "Moderate" },
    { city: "Los Angeles", vehicles: 18, avgHealth: 86, avgRange: 265, climate: "Warm" },
    { city: "Phoenix", vehicles: 8, avgHealth: 88, avgRange: 251, climate: "Hot" },
    { city: "Seattle", vehicles: 15, avgHealth: 93, avgRange: 295, climate: "Cool" },
    { city: "Denver", vehicles: 10, avgHealth: 89, avgRange: 275, climate: "Variable" }
  ];
        ...
        <Tabs defaultValue="battery-health" className="space-y-4">
          ...
          <TabsContent value="battery-health" className="space-y-4">
                ...
                <CardContent>
                  <ResponsiveContainer width="100%" height={300}>
                    <LineChart data={batteryHealthTrends}>
                      ...
                      <YAxis domain={[80, 100]} />
                      <Tooltip />
                      <Line type="monotone" dataKey="tesla" stroke="#ef4444" name="Tesla" />
                      <Line type="monotone" dataKey="nissan" stroke="#3b82f6" name="Nissan" />
                      <Line type="monotone" dataKey="ford" stroke="#10b981" name="Ford" />
                    </LineChart>
                  </ResponsiveContainer>
                </CardContent>
              </Card>
            ...
            <Alert>
              ...
              <AlertDescription>
                Vehicle EV002 (Nissan Leaf) showing accelerated battery degradation. 
